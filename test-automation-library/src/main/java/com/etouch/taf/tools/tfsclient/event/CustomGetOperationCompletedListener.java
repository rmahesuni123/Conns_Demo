...
/**
 * The listener interface for receiving customGetOperationCompleted events. The
 * class that is interested in processing a customGetOperationCompleted event
 * implements this interface, and the object created with that class is
 * registered with a component using the component's
 * <code>addCustomGetOperationCompletedListener<code> method. When
 * the customGetOperationCompleted event occurs, that object's appropriate
 * method is invoked.
 * 
 * @see CustomGetOperationCompletedEvent
 */
public class CustomGetOperationCompletedListener implements OperationCompletedListener {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.microsoft.tfs.core.clients.versioncontrol.events.
	 * OperationCompletedListener
	 * #onOperationCompleted(com.microsoft.tfs.core.clients
	 * .versioncontrol.events.OperationCompletedEvent)
	 */
