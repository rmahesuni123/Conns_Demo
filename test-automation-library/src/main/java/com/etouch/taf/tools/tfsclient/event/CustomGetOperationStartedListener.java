...
/**
 * The listener interface for receiving customGetOperationStarted events. The
 * class that is interested in processing a customGetOperationStarted event
 * implements this interface, and the object created with that class is
 * registered with a component using the component's
 * <code>addCustomGetOperationStartedListener<code> method. When
 * the customGetOperationStarted event occurs, that object's appropriate
 * method is invoked.
 * 
 * @see CustomGetOperationStartedEvent
 */
public class CustomGetOperationStartedListener implements OperationStartedListener {
	 ...
	 * #onOperationStarted(com.microsoft.tfs.core.clients.versioncontrol.events.
