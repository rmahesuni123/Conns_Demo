...
public class PDFFileReader {   
    ...
    public void parsePDFtoText(String pdfFile, String txtFile) throws IOException 
    {
        ...
        out.close();
        reader.close();
        log.debug("Parse PDF to text completed");
    }
     ...
     */
    public void extractImages(String fileName, String destPath)throws IOException, DocumentException {
        ...
        reader.close();
        log.debug("Image extraction completed");
    }   
}